...
public class DriveSourceSideCommand extends LoggingCommand {
     ...
     */
    public DriveSourceSideCommand(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, double rotation) {
